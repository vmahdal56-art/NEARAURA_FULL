    ...
    <div className="min-h-screen bg-black text-white font-sans flex flex-col items-center overflow-x-hidden">
      ...
      <div className="w-full flex-grow flex flex-col relative">
         ...
         <main className="flex-grow w-full flex relative h-[75vh]">
            ...
            <button onClick={handleNextMobile} className="lg:hidden absolute right-4 top-1/2 -translate-y-1/2 z-[100] text-zinc-500 hover:text-white bg-black/80 border border-zinc-700 p-3 rounded-full shadow-2xl backdrop-blur-md">
            ...
            {/* CENTER (BE THE HELP) */}
            <div 
              className={`relative ${mobileIndex === 1 ? 'flex' : 'hidden'} lg:flex w-full lg:w-1/3 flex-col items-center justify-center border-r border-zinc-900 bg-black overflow-hidden group cursor-pointer transition-all duration-500`} 
            ...
            {/* RIGHT (THE ROOTS) */}
            <div 
              className={`relative ${mobileIndex === 2 ? 'flex' : 'hidden'} lg:flex w-full lg:w-1/3 flex-col items-center justify-center bg-black overflow-hidden group cursor-pointer transition-all duration-500`} 
