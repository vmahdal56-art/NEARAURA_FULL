...
const SHARED_CODE = `
  ...
  const LangSwitch = () => (
    <div className="fixed top-4 right-4 z-[100] flex gap-2 bg-black/90 border border-zinc-800 p-1.5 rounded-full shadow-[0_0_20px_rgba(34,211,238,0.3)]">
    ...
    <div className="min-h-screen w-full bg-[#050505] text-white flex flex-col items-center p-6 font-mono relative pb-48 overflow-y-auto uppercase font-black">
      ...
      <div className="max-w-5xl w-full space-y-24">
        ...
        <div className="w-full bg-zinc-950 border-l-8 border-zinc-800 p-8 space-y-16 shadow-2xl relative">
           <h3 className="text-zinc-500 text-3xl mb-12 tracking-widest border-b border-zinc-900 pb-4 italic">{t("HISTORICKÁ OSA AURY", "THE AURA TIMELINE")}</h3>
           ...
           <div className="relative border-l-2 border-zinc-800 pl-10 space-y-24 text-left">
              ...
              <div>
                 ...
                 <p className="text-zinc-500 text-sm mt-2 leading-relaxed">{t("VAJÍČKA V MOSTE. POCTIVÝ MATERIÁL. ŽÁDNÝ ŠIZENÝ CEMENT. ZÁKLADY, KTERÉ DRŽÍ.", "EGGS IN THE BRIDGE. NO CHEAP CEMENT. FOUNDATIONS THAT LAST.")}</p>
              </div>
              ...
              <div>
                 ...
                 <p className="text-zinc-400 text-sm mt-2 leading-relaxed">
                    {t("DAVOS. GRÓNSKO TAJE. VÁLKY. GAZA. ČIPY. MARS. SYNTETICKÝ VRCHOL.", "DAVOS. ICE MELTS. WARS. GAZA. CHIPS. MARS. SYNTHETIC PEAK.")}
                 </p>
              </div>
